...
export const routes: Routes = [

    {
        ...
        children: [
            ...
            { path: 'cuentas', loadChildren: () => import('./template/cuentas/cuentas.module').then(m => m.CuentasModule) },
            { path: 'proyectos', loadChildren: () => import('./template/proyectos/proyectos.module').then(m => m.ProyectosModule) },
            { path: 'procedimientos', loadChildren: () => import('./template/procedimientos/procedimientos.module').then(m => m.ProcedimientosModule) },
            { path: 'campos', loadChildren: () => import('./template/campos/campos.module').then(m => m.CamposModule) },
            { path: 'produccion', loadChildren: () => import('./template/produccion/produccion.module').then(m => m.ProduccionModule) },
            { path: 'variedades', loadChildren: () => import('./template/variedades/variedades.module').then(m => m.VariedadesModule) },
            { path: 'personas', loadChildren: () => import('./template/personas/personas.module').then(m => m.PersonasModule) },
            { path: 'reportes', loadChildren: () => import('./template/reportes/reportes.module').then(m => m.ReportesModule) },
